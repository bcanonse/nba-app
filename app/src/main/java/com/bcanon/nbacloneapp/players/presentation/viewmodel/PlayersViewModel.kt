...
import com.bcanon.nbacloneapp.players.presentation.ui.PlayersState
import com.bcanon.nbacloneapp.players.presentation.ui.UiAction
...
class PlayersViewModel @Inject constructor(
    ...
    var state: StateFlow<PlayersState>

    val pagingDataFlow: Flow<PagingData<Players>>
    ...
    private fun searchRepo(queryString: String): Flow<PagingData<Players>> =
        getPlayersUseCase(queryString)
